...
class home_page(base):
    ...
    def home_fn(self):
        ...
        select_x_btn = Button(frame1, text='Independent X', relief=GROOVE, command=select_x_fn,width=13 )
        select_x_btn.place(x=100, y=450)

        choose1=Label(frame1,text="Independent X",font=("Futura", "16", "bold"), bg='white', relief=RAISED)
        choose1.place(x=450,y=130)
